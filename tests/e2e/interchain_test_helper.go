...
// FIX: NewTestLogger returns common.Logger (interface). We need the concrete
// *TestLogger here, so we construct it directly instead of going through
// the interface-returning factory.
